...
Tested up to: 4.1.1.
Stable tag: 1.9.3.57257

======== Changelog =======
Version 1.9.3.57257 - March 15, 2015
* Compatibility Fix: Broken drop down menus

Version 1.9.2.54708 - November 11, 2014
* Bug Fixed: Visual Columns break the behavior of the “kitchensink” format dropdown
* Bug Fixed: Using format (h3, p etc.) inside columns was broken

Version 1.9.1.53988 - September 16, 2014
* Compatibility Fix: In WordPress 4.0 the insert tool for Shortcodes was partially hidden behind the visual editor
